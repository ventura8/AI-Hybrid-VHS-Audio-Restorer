...
This repository defines agent-specific guidance and reusable skills for development workflows.
...
This command runs PowerShell lint, Ruff, Flake8, Pylint, tests with coverage, and regenerates `assets/coverage.svg`.
