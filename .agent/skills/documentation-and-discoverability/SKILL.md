...
2. Add discoverability links in `README.md` when new docs are introduced.
3. Keep `.agent/instructions.md` documentation index aligned with available docs.
4. Ensure guidance does not conflict across docs.
