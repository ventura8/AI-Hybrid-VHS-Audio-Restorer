...
if [ -n "$PWSH_BIN" ]; then
    ...
    "$PWSH_BIN" -NoProfile -Command '& ./.github/scripts/Invoke-PowerShellLint.ps1 -ScriptPaths @("./install_dependencies.ps1", "./run_pipeline_locally.ps1", "./scripts/install_pr_review_tooling.ps1", "./.github/scripts/Invoke-PowerShellLint.ps1")'
else
